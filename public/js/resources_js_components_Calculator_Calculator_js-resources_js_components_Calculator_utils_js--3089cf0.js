(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Calculator_Calculator_js-resources_js_components_Calculator_utils_js--3089cf0"],{
...
/* harmony import */ var _calculator_values_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calculator-values.js */ "./resources/js/components/Calculator/calculator-values.js");
...
var ServiceCalculatorSchema = yup__WEBPACK_IMPORTED_MODULE_2__.object().shape({
  services: yup__WEBPACK_IMPORTED_MODULE_2__.array().of(yup__WEBPACK_IMPORTED_MODULE_2__.object().shape({
    width: yup__WEBPACK_IMPORTED_MODULE_2__.string().required('Required'),
    height: yup__WEBPACK_IMPORTED_MODULE_2__.string().required('Required'),
    quantity: yup__WEBPACK_IMPORTED_MODULE_2__.string().required('Required'),
    currentServiceType: yup__WEBPACK_IMPORTED_MODULE_2__.object().required('Required'),
    currentService: yup__WEBPACK_IMPORTED_MODULE_2__.object().required('Required')
  }))
});
var serviceTypeOptions = Object.keys(_calculator_values_js__WEBPACK_IMPORTED_MODULE_3__.calculatorValues.services).reduce(function (accum, service) {
  accum.push({
    value: service,
    label: service
  });
...
var servicesForOptions = Object.keys(_calculator_values_js__WEBPACK_IMPORTED_MODULE_3__.calculatorValues.services).reduce(function (accum, serviceType) {
  accum[serviceType] = _calculator_values_js__WEBPACK_IMPORTED_MODULE_3__.calculatorValues.services[serviceType].map(function (service) {
    return {
      value: service.name,
      label: service.name,
      price: service.price,
...
function Calculator(_ref) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function () {
    var totalCalculated = values.services.reduce(function (total, service) {
      var _calculatePrice = (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.calculatePrice)(service),
          currentPrice = _calculatePrice.total;
  ...
  var updateServiceByIndex = function updateServiceByIndex(services, field, value, index) {
    return services.map(function (service, idx) {
      if (idx === index) {
        ...
        var _calculatePrice2 = (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.calculatePrice)(updatedService),
            total = _calculatePrice2.total,
            totalPerSqFt = _calculatePrice2.totalPerSqFt,
            totalPerItem = _calculatePrice2.totalPerItem;
  ...
  var setFieldValueNested = function setFieldValueNested(field, value, index) {
    ...
    var price = (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.countTotal)((0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.calculatePrice)(updatedServiceByUserField[index]).total);
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nSyntaxError: /Users/aleksandr/Sites/separate-logins/resources/js/components/Calculator/CalculatorTabScreen.js: Unexpected token, expected \",\" (175:85)\n\n\u001b[0m \u001b[90m 173 |\u001b[39m                     \u001b[33m<\u001b[39m\u001b[33mlabel\u001b[39m\u001b[33m>\u001b[39m\u001b[33mTotal\u001b[39m \u001b[33mHeight\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mlabel\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 174 |\u001b[39m                     {calculatorValues\u001b[33m.\u001b[39mheight\u001b[33m.\u001b[39mmap(({ title\u001b[33m,\u001b[39m price }) \u001b[33m=>\u001b[39m (\u001b[0m\n\u001b[0m\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 175 |\u001b[39m                         \u001b[33m<\u001b[39m\u001b[33mdiv\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"form-check\"\u001b[39m key\u001b[33m=\u001b[39m{title} onClick\u001b[33m=\u001b[39m{onChange\u001b[33m=\u001b[39m{e \u001b[33m=>\u001b[39m setFieldValueNested(\u001b[32m'ftHeight'\u001b[39m\u001b[33m,\u001b[39m { title\u001b[33m,\u001b[39m price }\u001b[33m,\u001b[39m index)}}\u001b[33m>\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m     |\u001b[39m                                                                                      \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 176 |\u001b[39m                             \u001b[33m<\u001b[39m\u001b[33minput\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 177 |\u001b[39m                                 className\u001b[33m=\u001b[39m\u001b[32m\"form-check-input\"\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 178 |\u001b[39m                                 type\u001b[33m=\u001b[39m\u001b[32m\"radio\"\u001b[39m\u001b[0m\n    at Object._raise (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:816:17)\n    at Object.raiseWithData (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:809:17)\n    at Object.raise (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:770:17)\n    at Object.unexpected (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:9905:16)\n    at Object.expect (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:9879:28)\n    at Object.parseObjectLike (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:11694:14)\n    at Object.parseExprAtom (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:11222:23)\n    at Object.parseExprAtom (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:5245:20)\n    at Object.parseExprSubscripts (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:10878:23)\n    at Object.parseUpdate (/Users/aleksandr/Sites/separate-logins/node_modules/@babel/parser/lib/index.js:10858:21)");
...
var calculatorValues = {
  services: {
    ...
    "Letters": [{
      "name": "Dimensions letters - plastic",
      "price": 50
    }, {
...
/***/ "./resources/js/components/Calculator/utils.js":
/*!*****************************************************!*\
  !*** ./resources/js/components/Calculator/utils.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calculator */ "./resources/js/components/Calculator/Calculator.js");

var calculatePrice = function calculatePrice(service) {
  var width = service.width,
