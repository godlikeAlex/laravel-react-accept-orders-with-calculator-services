...
/* harmony export */   "setServiceTotalTo": () => (/* binding */ setServiceTotalTo),
/* harmony export */   "setTotalTo": () => (/* binding */ setTotalTo),
...
/* harmony export */   "updatePrices": () => (/* binding */ updatePrices),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
var cartSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.createSlice)({
  ...
  initialState: {
    ...
    totalServices: 0,
    prices: {
      installation: _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE,
      removal: 0,
      survey: 0,
  ...
  reducers: {
    ...
    updateQuantity: function updateQuantity(state, _ref3) {
      var payload = _ref3.payload;
      ...
      state.services = state.services.map(function (service, idx) {
        if (idx === index) {
          ...
          var calculatedPrice = (0,_components_Calculator_utils__WEBPACK_IMPORTED_MODULE_1__.calculatePrice)(serviceToUpdate);
          serviceToUpdate.price = calculatedPrice.total <= _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE ? _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE : calculatedPrice.total;
    ...
    updatePrices: function updatePrices(state, _ref4) {
    ...
    setTotalTo: function setTotalTo(state, _ref5) {
    ...
    setServiceTotalTo: function setServiceTotalTo(state, _ref6) {
...
var _cartSlice$actions = cartSlice.actions,
    ...
    setServiceTotalTo = _cartSlice$actions.setServiceTotalTo,
    setTotalTo = _cartSlice$actions.setTotalTo,
    ...
    updatePrices = _cartSlice$actions.updatePrices;
...
var stripePromise = (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("pk_test_51JAtkbFjRSGcEV2oi1h9MyFh3NqseceLKcQfKcfe9tHc3jHuzRO9hJxDG3nt5fwriodR2EZqazKxuKfEkcAW205700RzCRW48t");
