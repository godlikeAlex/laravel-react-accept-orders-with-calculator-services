(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_App_root_js"],{
...
/***/ "./resources/js/App/components/Auth/authSlice.js":
/*!*******************************************************!*\
  !*** ./resources/js/App/components/Auth/authSlice.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var authSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  ...
  reducers: {
    initAuth: function initAuth(state, _ref) {
...
/***/ "./resources/js/App/redux/cartSlice.js":
/*!*********************************************!*\
  !*** ./resources/js/App/redux/cartSlice.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "toggleAditional": () => (/* binding */ toggleAditional),
/* harmony export */   "extendCart": () => (/* binding */ extendCart),
...
/* harmony export */   "togglerPrices": () => (/* binding */ togglerPrices),
/* harmony export */   "updateCartPrice": () => (/* binding */ updateCartPrice),
/* harmony export */   "setDelivery": () => (/* binding */ setDelivery),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
/* harmony import */ var _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/Calculator/Calculator */ "./resources/js/components/Calculator/Calculator.js");
/* harmony import */ var _components_Calculator_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/Calculator/utils */ "./resources/js/components/Calculator/utils.js");
/* harmony import */ var _common_cart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/cart */ "./resources/js/common/cart.js");
...
var cartSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__.createSlice)({
  name: 'cart',
  initialState: {
    services: [],
    additional: {
  ...
  reducers: {
    initCart: function initCart(state, _ref) {
      var payload = _ref.payload;

      var _countAllCart = (0,_common_cart__WEBPACK_IMPORTED_MODULE_2__.countAllCart)({
        ...
        total: payload.total || 0
          ...
          services = _countAllCart.services,
    ...
    updateCartPrice: function updateCartPrice(state) {
      var _countAllCart2 = (0,_common_cart__WEBPACK_IMPORTED_MODULE_2__.countAllCart)({
        services: state.services,
        additional: state.additional,
        total: state.total
      }),
          additional = _countAllCart2.additional,
          total = _countAllCart2.total;

      state.additional = additional;
      state.total = total < _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE ? _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE : total;
    },
    updateQuantity: function updateQuantity(state, _ref2) {
      var payload = _ref2.payload;
      var type = payload.type,
          index = payload.index;
      state.services = state.services.map(function (service, idx) {
        if (idx === index) {
          var serviceToUpdate = _objectSpread({}, service);
          ...
          var calculatedPrice = (0,_common_cart__WEBPACK_IMPORTED_MODULE_2__.countService)(serviceToUpdate);
    ...
    toggleAditional: function toggleAditional(state, _ref3) {
      var additionalType = _ref3.payload;
      var _state$additional = state.additional,
          urgencyInstsllstion = _state$additional.urgencyInstsllstion,
          survey = _state$additional.survey;

      switch (additionalType) {
        case 'urgencyInstsllstion':
          var countTotalOfServices = state.services.reduce(function (total, service) {
    ...
    removeFromCart: function removeFromCart(state, _ref4) {
      var index = _ref4.payload;
      state.services = state.services.filter(function (_, idx) {
        return idx !== index;
      });
    },
    ...
    setDelivery: function setDelivery(state, _ref5) {
      var payload = _ref5.payload;
      state.delivery = payload;
    },
    togglerPrices: function togglerPrices(state, _ref6) {
      ...
      state.services = state.services.map(function (service, idx) {
        if (idx === index) {
          ...
          var _serviceToUpdate$pric = serviceToUpdate.prices,
              installation = _serviceToUpdate$pric.installation,
              removal = _serviceToUpdate$pric.removal;
    ...
    extendCart: function extendCart(state, _ref7) {
      var payload = _ref7.payload;
      var additional = state.additional,
          total = state.total;
      var counted = (0,_common_cart__WEBPACK_IMPORTED_MODULE_2__.countAllCart)({
        services: [].concat(_toConsumableArray(state.services), _toConsumableArray(payload.services)),
    ...
    // asd
    updatePrices: function updatePrices(state, _ref8) {
      var payload = _ref8.payload;
      var totalServices = state.totalServices,
          prices = state.prices,
          total = state.total;
      ...
      if (state.prices.urgencyInstsllstion != 0) {
        var _total = state.prices.installation + state.prices.removal + state.prices.survey;

        state.prices.urgencyInstsllstion = _total * 0.20;
      }
    },
    setTotalTo: function setTotalTo(state, _ref9) {
      var payload = _ref9.payload;
      state.total = payload < _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE ? _components_Calculator_Calculator__WEBPACK_IMPORTED_MODULE_0__.MIN_PRICE : payload;
    }
  }
});
var _cartSlice$actions = cartSlice.actions,
    removeFromCart = _cartSlice$actions.removeFromCart,
    toggleAditional = _cartSlice$actions.toggleAditional,
    extendCart = _cartSlice$actions.extendCart,
    initCart = _cartSlice$actions.initCart,
    updateQuantity = _cartSlice$actions.updateQuantity,
    clearCart = _cartSlice$actions.clearCart,
    togglerPrices = _cartSlice$actions.togglerPrices,
    updateCartPrice = _cartSlice$actions.updateCartPrice,
    setDelivery = _cartSlice$actions.setDelivery;

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (cartSlice.reducer);

/***/ }),

/***/ "./resources/js/App/root.js":
/*!**********************************!*\
  !*** ./resources/js/App/root.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "./resources/js/App/store.js");
...
var App = (0,_loadable_component__WEBPACK_IMPORTED_MODULE_6__["default"])(function () {
  return __webpack_require__.e(/*! import() */ "resources_js_App_components_App_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ./components/App */ "./resources/js/App/components/App/index.js"));
});
var stripePromise = (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("pk_live_2c6BLV7ldHOWb2mKXNiEjy1J00U1uCdhct");

function Root() {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_stripe_react_stripe_js__WEBPACK_IMPORTED_MODULE_5__.Elements, {
...
/* harmony import */ var _redux_cartSlice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./redux/cartSlice */ "./resources/js/App/redux/cartSlice.js");
/* harmony import */ var _components_Auth_authSlice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Auth/authSlice */ "./resources/js/App/components/Auth/authSlice.js");



var store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.configureStore)({
  reducer: {
    cart: _redux_cartSlice__WEBPACK_IMPORTED_MODULE_0__["default"],
    auth: _components_Auth_authSlice__WEBPACK_IMPORTED_MODULE_1__["default"]
  }
});
