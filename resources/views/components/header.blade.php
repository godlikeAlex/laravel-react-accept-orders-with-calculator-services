<div class="transparent_wrapper">
    <div class="page_header_wrapper header_white affix-top-wrapper" style="height: 80px;">
        <header class="page_header header_v2 header_white toggler_xxs_right affix-top">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 display-flex v-center">
                        <div class="header_left_logo" style="min-width: 142px;"> <a href="/" class="logo">
                                <img src="/frontend/images/logo-light.webp" alt="">
